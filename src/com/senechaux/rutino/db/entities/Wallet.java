...
public class Wallet extends BaseEntity {
    ...
    /**
     * Creates and returns an instance of the wallet from the provided JSON data.
     * 
     * @param wallet The JSONObject containing wallet data
     * @return wallet The new instance of Voiper user created from the JSON data.
     */
    public static Wallet valueOf(JSONObject wallet) {
        try {
            final int mobileId = wallet.has("mobile_id") ? wallet.getInt("mobile_id") : null;
            //final int userId = wallet.has("user_id") ? wallet.getInt("uid") : null;
